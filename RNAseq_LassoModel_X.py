...
Lasso_reg_lambda = np.concatenate([Lasso_reg_lambda, np.arange(1e-3,11e-3,1e-3)])
Lasso_reg_lambda = np.concatenate([Lasso_reg_lambda, np.arange(0.01,0.1,0.01)])
Lasso_reg_lambda = np.concatenate([Lasso_reg_lambda, np.arange(0,1.1,0.1)])
