...
activation_flag = 3;  # sets the activation function type to RELU[1], ELU[2], tanh[3] (initialized a certain way,dropout has to be done differently) , or tanh()
...
dict_training_params = {'step_size_val': 00.5, 'train_error_threshold': float(1e-20),'valid_error_threshold': float(1e-6), 'max_epochs': 20000, 'batch_size': BATCH_SIZE} #20000
...
# ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.1, 'train_error_threshold': float(1e-7), 'valid_error_threshold': float(1e-7), 'max_epochs': 50000, 'batch_size': BATCH_SIZE}
# ls_dict_training_params.append(dict_training_params)
...
# # # ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.05, 'train_error_threshold': float(1e-8), 'valid_error_threshold': float(1e-8), 'max_epochs': 5000, 'batch_size': BATCH_SIZE}
# ls_dict_training_params.append(dict_training_params)
