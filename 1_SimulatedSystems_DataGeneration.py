...
dict_run_conditions = {}
# MICROTENSOR CPU RUN
# dict_run_conditions[0] = {'x_dict_size':3,'x_nn_layers':5,'x_nn_nodes':6}
# dict_run_conditions[1] = {'x_dict_size':3,'x_nn_layers':5,'x_nn_nodes':9}
# dict_run_conditions[2] = {'x_dict_size':3,'x_nn_layers':5,'x_nn_nodes':12}
# dict_run_conditions[3] = {'x_dict_size':3,'x_nn_layers':5,'x_nn_nodes':15}
# dict_run_conditions[4] = {'x_dict_size':3,'x_nn_layers':5,'x_nn_nodes':18}
# dict_run_conditions[5] = {'x_dict_size':4,'x_nn_layers':5,'x_nn_nodes':6}
# dict_run_conditions[6] = {'x_dict_size':4,'x_nn_layers':5,'x_nn_nodes':9}
# Runs
dict_run_conditions[0] = {'x_dict_size':4,'x_nn_layers':4,'x_nn_nodes':6}
dict_run_conditions[1] = {'x_dict_size':4,'x_nn_layers':4,'x_nn_nodes':9}
dict_run_conditions[2] = {'x_dict_size':4,'x_nn_layers':4,'x_nn_nodes':12}
dict_run_conditions[3] = {'x_dict_size':4,'x_nn_layers':4,'x_nn_nodes':15}
dict_run_conditions[4] = {'x_dict_size':4,'x_nn_layers':4,'x_nn_nodes':18}
