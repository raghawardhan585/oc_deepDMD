...
SYSTEM_NO = 708  #410,411,412
ls_conditions = ['MX']
ls_runs1 = list(range(0,60)) # SYSTEM 408

# Sequential deepDMD
# df_results2_deepDMD = rnaf.generate_n_step_prediction_table(SYSTEM_NO,ALL_CONDITIONS= ls_conditions,ls_runs1= list(range(0,100)),METHOD = 'Sequential')
...
# Direct deepDMD
df_results2_OCdeepDMD = rnaf.generate_n_step_prediction_table(SYSTEM_NO,ALL_CONDITIONS= ls_conditions,ls_runs1= list(range(0,100)),METHOD = 'deepDMD')
...
# rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 707, run = 3, METHOD = 'deepDMD',ALL_CONDITIONS=['MX'])
# rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 707, run = 0, METHOD = 'Sequential',ALL_CONDITIONS=['MX'])


# rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 708, run = 1, METHOD = 'deepDMD',ALL_CONDITIONS=['MX'])
# rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 708, run = 1, METHOD = 'Sequential',ALL_CONDITIONS=['MX'])
...
#
# sb.heatmap(dict_params['WhT_num'].T)
# plt.show()
#
...
# dict_temp = rnaf.get_train_test_valid_data(SYSTEM_NO, ALL_CONDITIONS=ALL_CONDITIONS)
# data_raw = dict_unscaled_data[COND][data_index]['XfT']
# data_filtered = np.empty(shape=(6,0))
# for i in range(3):
#
#     data_filtered = np.concatenate([data_filtered,sf(data_raw[:,i],5,3).reshape((-1,1))],axis=1)
#
# plt.plot(data_raw)
# plt.ylim([0,500])
# plt.show()
