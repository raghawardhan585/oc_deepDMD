...
for DEVICE_TO_RUN_ON in ['microtensor','optictensor','goldentensor']:
    if DEVICE_TO_RUN_ON == 'microtensor':
        ...
        dict_run_conditions[1]['x']  = {'dict_size':10,'nn_layers':4,'nn_nodes':16}
        ...
        dict_run_conditions[1] = {}
        dict_run_conditions[1]['x']  = {'dict_size':12,'nn_layers':4,'nn_nodes':18}
        ...
        dict_run_conditions[3] = {}
        dict_run_conditions[3]['x']  = {'dict_size':12,'nn_layers':5,'nn_nodes':18}
