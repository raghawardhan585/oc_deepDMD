...
dict_hp={}
dict_hp['x']={}
dict_hp['x']['ls_dict_size'] = [0,2,4,8]
dict_hp['x']['ls_nn_layers'] = [3,4,3,4]
...
ls_regularization_parameter = [0] #np.arange(0, 1e-3, 2.5e-5)#np.concatenate([np.array([0]),np.arange(2e-5, 9.5e-5, 0.5e-5)],axis=0)#np.arange(0, 1e-3, 2.5e-5) #[3.75e-4] #np.arange(5e-5,1e-3,2.5e-5)
