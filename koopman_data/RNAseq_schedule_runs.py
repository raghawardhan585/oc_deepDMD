...
dict_hp={}
dict_hp['x']={}
dict_hp['x']['ls_dict_size'] = [0,0,2,2,4,4,8,8,10,10,12,12,15,15,18,18,20,20,25,25]
dict_hp['x']['ls_nn_layers'] = [3]
dict_hp['x']['ls_nn_nodes'] = [25]
dict_hp['y']={}
...
ls_regularization_parameter = [6e-5] #np.concatenate([np.array([0]),np.arange(2e-5, 7.5e-5, 0.5e-5)],axis=0)#np.arange(0, 1e-3, 2.5e-5) #[3.75e-4] #np.arange(5e-5,1e-3,2.5e-5)
