...
DATA_SYSTEM_TO_WRITE_BASH_SCRIPT_FOR = 800
...
# qt.write('python3 RNAseq_LassoModel_X.py > System_' + str(DATA_SYSTEM_TO_WRITE_BASH_SCRIPT_FOR) + '/Lasso_Regression_X/LassoRun.txt &\n')
# qt.write('wait \n')
