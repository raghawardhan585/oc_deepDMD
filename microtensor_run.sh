...
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 1  1 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_1.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 2  2 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_2.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 3  2 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_3.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 4  3 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_4.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 5  3 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_5.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 6  4 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_6.txt &
wait 
python3 ocdeepDMD_Sequential.py '/cpu:0' 701 7  4 4 10 1 1 1 1 1 1 0 > Run_info/SYS_701_RUN_7.txt &
wait 
wait 
