...
rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 704, run = 4, METHOD = 'deepDMD',ALL_CONDITIONS=['MX'])
# rnaf.plot_dynamics_related_graphs(SYSTEM_NO = 704, run = 3, METHOD = 'Sequential',ALL_CONDITIONS=['MX'])
